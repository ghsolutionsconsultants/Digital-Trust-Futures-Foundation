...
type IconName =
  | 'arrow' | 'shield' | 'shield-check' | 'code' | 'book' | 'cap'
  | 'buoy' | 'lock' | 'globe' | 'users' | 'file' | 'activity'
  | 'layers' | 'alert' | 'mail' | 'pin' | 'external' | 'download'
  | 'key' | 'branch' | 'chart' | 'search' | 'scale' | 'credit-card'
  | 'cpu' | 'refresh' | 'megaphone' | 'calendar' | 'check' | 'eye-off';
...
export function Icon({ name, className, size, 'aria-hidden': ariaHidden = true }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function ArrowIcon() {
  return <Icon name="arrow" className="arrow" />;
}
